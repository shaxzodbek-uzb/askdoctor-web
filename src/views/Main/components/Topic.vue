<template>
	<div>
		<section class="section-content padding-top vld-parent">
            <div class="container">
          <loading :active.sync="isLoading" :can-cancel="true" color="green" :opacity="0.7" :height="54" :width="54" :is-full-page="fullPage"></loading>
            ...
            <div class="tab-pane fade show active" id="topic_adult">
              <div class="row row-sm category-dard minimized">

                <div class="col-md-2 col-6 col-dard visible element" v-for="item in items" :key="item.id">
                ...
                <div class="col-md-2 col-6 col-expand">
                  <a href="#" class="item-dard control btn-dard-expand" @click.prevent="doAjax" @click="koproq()">
                      <div class="icon-wrap">
                ...
                <div class="col-md-2 col-6 col-minimize">
                  <a href="#" class="item-dard control btn-dard-minimize" @click.prevent="doAjax" @click="kamroq()">
                      <div class="icon-wrap">
            ...
            <div class="row row-sm category-dard minimized">
                <div class="col-md-2 col-6 col-dard visible" v-for="item2 in items2" :key="item2.id">
                  <router-link to="/express" class="item-dard">
                      <div class="icon-wrap">
